...
class Paginator {
     ...
     */
//    public function __construct($cfg, $itemsPerPage, $currentPage, $urlPattern = '') {
    public function __construct($cfg, $currentPage) {
        ...
        $this->itemsPerPage = $cfg['stat']['rowsPerPage'];
        $this->urlPattern   = $cfg['stat']['urlPattern'];
        $this->currentPage  = $currentPage;

        $this->totalItems =
            $dbh->getValue(
                $qMap->getQuery('SELECT_VISITOR_CNT'),
                [],0
            );
     ...
     * @return int
     */
    public function getMaxPagesToShow() { return $this->maxPagesToShow; }
     ...
     */
    public function setUrlPattern($urlPattern) { $this->urlPattern = $urlPattern; }

    /**
     * @return string
     */
    public function getUrlPattern() { return $this->urlPattern; }
    ...
    public function getPages() {
        ...
        if ($this->numPages <= 1) { return array(); }
    ...
    public function getCurrentPageFirstItem() {
        ...
        if ($first > $this->totalItems) { return null; }
        return $first;
    }
    ...
    public function getCurrentPageLastItem() {
        ...
        if ($last > $this->totalItems) { return $this->totalItems; }
        return $last;
    }
